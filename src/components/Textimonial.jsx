      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center  gap-3 mb-2">
            ...
            <h2 className="text-2xl font-bold text-white">What they say</h2>
          </div>
        </div>
        ...
        <div className="relative">
          <div className="bg-gray-900 rounded-2xl p-8 md:p-12 shadow-2xl border border-gray-800">
            <div className="flex flex-col md:flex-row items-start gap-6">
              ...
              <div className="flex-1">
                ...
                {/* Quote */}
                <div className="relative">
                  <div className="text-6xl text-gray-600 absolute -top-4 -left-2 font-serif">"</div>
          ...
          <button
            ...
            className="absolute left-4 top-1/2 transform -translate-y-1/2 -translate-x-full bg-gray-800 hover:bg-gray-700 text-white p-3 rounded-full transition-colors duration-200 hidden md:flex items-center justify-center"
          >
          ...
          <button
            ...
            className="absolute right-4 top-1/2 transform -translate-y-1/2 translate-x-full bg-gray-800 hover:bg-gray-700 text-white p-3 rounded-full transition-colors duration-200 hidden md:flex items-center justify-center"
          >
