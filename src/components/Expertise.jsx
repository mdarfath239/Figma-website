    ...
    <section className="w-full bg-black text-white py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center  mb-16">
          ...
          <h2 className="font-['Work_Sans'] text-5xl font-bold text-white">Expertise</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16">
          ...
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-['Work_Sans'] text-2xl font-bold text-white mb-2">Branding</h3>
          ...
          <div className="flex items-start">
            <span className="text-white text-lg mr-3">•</span>
            <div>
              <h3 className="font-['Work_Sans'] text-2xl font-bold text-white mb-2">UI Design</h3>
              <p className="text-gray-400 text-base">
          ...
          <div className="flex items-start">
            <span className="text-white text-lg mr-3">•</span>
            <div>
              <h3 className="font-['Work_Sans'] text-2xl font-bold text-white mb-2">UX Design</h3>
              <p className="text-gray-400 text-base">
          ...
          <div className="flex items-start">
            <span className="text-white text-lg mr-3">•</span>
            <div>
              <h3 className="font-['Work_Sans'] text-2xl font-bold text-white mb-2">Development</h3>
              <p className="text-gray-400 text-base">
